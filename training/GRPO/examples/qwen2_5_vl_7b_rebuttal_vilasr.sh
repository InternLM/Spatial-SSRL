...
MODEL_PATH=/mnt/shared-storage-user/liuyuhong1/LLaMA-Factory/output/qwen2_5vl_lora_0919_step75  # replace it with your local file path

python3 -m verl.trainer.main \
    config=examples/config.yaml \
    data.format_prompt=./examples/format_prompt/math.jinja \
    data.train_files=/mnt/shared-storage-user/mllm/shared/liuyuhong/dataset/Shuffle_image/four-types-80k-0920@train \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_rebuttal_vilasr \
